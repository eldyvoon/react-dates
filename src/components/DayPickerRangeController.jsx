...
const propTypes = forbidExtraProps({
  ...
  //custom,
  customMobileHeader: PropTypes.func,
  customMobileFooter: PropTypes.func
});
...
export default class DayPickerRangeController extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <>
        {this.props.customMobileHeader && this.props.customMobileHeader()}
        ...
        {this.props.customMobileFooter && this.props.customMobileFooter()}
      </>
    );
  }
}
